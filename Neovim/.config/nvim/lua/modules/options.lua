...
vim.opt.hlsearch = true			    	--highlight all matches on previos search pattern--
...
vim.opt.guifont = "monospace:h17"		--font used in neovim applications
...
vim.opt.guicursor ="n-v-c:25-Cursor/ICursor-blinkon0"
vim.opt.guicursor ="n:25-Cursor/Cursocr-blink"
